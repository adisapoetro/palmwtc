...
.. autoapisummary::
   ...
   palmwtc.qc.rules.apply_physical_bounds_flags
   palmwtc.qc.rules.apply_iqr_flags
   palmwtc.qc.rules.combine_qc_flags
   palmwtc.qc.rules.generate_qc_summary
   palmwtc.qc.rules.get_variable_config
   palmwtc.qc.rules.apply_rate_of_change_flags
   palmwtc.qc.rules.apply_persistence_flags
   palmwtc.qc.rules.apply_battery_proxy_flags
   palmwtc.qc.rules._load_sensor_exclusions
   palmwtc.qc.rules.apply_sensor_exclusion_flags
   palmwtc.qc.rules.generate_exclusion_recommendations
   palmwtc.qc.rules.process_variable_qc
   palmwtc.qc.rules.add_cycle_id
...
.. py:function:: _load_sensor_exclusions(config_path=None)
