...
.. py:module:: palmwtc.flux.chamber
...
.. autoapisummary::
   ...
   palmwtc.flux.chamber.apply_wpl_correction
   palmwtc.flux.chamber._choose_h2o_column
   palmwtc.flux.chamber.prepare_chamber_data
   palmwtc.flux.chamber.summarize_wpl_correction
   palmwtc.flux.chamber.build_cycle_wpl_metrics
   palmwtc.flux.chamber.calculate_flux_cycles
   palmwtc.flux.chamber.calculate_h2o_flux_for_cycle
   palmwtc.flux.chamber.score_h2o_flux_qc
   palmwtc.flux.chamber.calculate_h2o_flux_cycles
   palmwtc.flux.chamber.load_tree_biophysics
   palmwtc.flux.chamber.get_tree_volume_at_date
   palmwtc.flux.chamber.apply_wpl_qc_overrides
   palmwtc.flux.chamber.compute_closure_confidence
...
.. py:function:: _choose_h2o_column(data, chamber_suffix, prefer_corrected=True)
