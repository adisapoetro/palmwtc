...
# ruff: noqa: RUF013
# Implicit Optional on ``random_seed: int = None`` and
# ``skip_persistence: list = None`` is intentional — those defaults
# originate in the original procedural function and are preserved here
...
class QCProcessor:
    ...
    def __init__(self, df: pd.DataFrame, config_dict: dict) -> None:
        self.df = df.copy()
